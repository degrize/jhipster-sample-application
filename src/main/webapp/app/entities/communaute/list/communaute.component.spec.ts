...
describe('Component Tests', () => {
  describe('Communaute Management Component', () => {
    let comp: CommunauteComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CommunauteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.communautes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
