  ...
  describe('Departement Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = {
        ...
        videoIntroductionContentType: 'image/png',
        videoIntroduction: 'AAAAAAA',
        contactResponsable: 'AAAAAAA',
        description: 'AAAAAAA',
        couleur1: 'AAAAAAA',
        couleur2: 'AAAAAAA',
      };
    ...
    describe('Service methods', () => {
        ...
        const returnedFromService = Object.assign(
          {
            ...
            videoIntroduction: 'BBBBBB',
            contactResponsable: 'BBBBBB',
            description: 'BBBBBB',
            couleur1: 'BBBBBB',
            couleur2: 'BBBBBB',
          },
      ...
      describe('addDepartementToCollectionIfMissing', () => {
        ...
        it('should add only unique Departement to an array', () => {
          const departementArray: IDepartement[] = [{ id: 123 }, { id: 456 }, { id: 7854 }];
