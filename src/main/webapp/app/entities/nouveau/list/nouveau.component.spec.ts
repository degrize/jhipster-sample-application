...
describe('Component Tests', () => {
  describe('Nouveau Management Component', () => {
    let comp: NouveauComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(NouveauComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.nouveaus?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
